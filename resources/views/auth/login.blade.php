...
<head>
    ...
    <title>Romil Sewa Sanstha - Login</title>
    <style>
        body {
...
<body>
    <div class="card">
        ...
        <form action="{{ route('login') }}" method="POST">
            ...
            <p class="subtitle">Don't have an account? <a class="green" href="{{ route('register') }}"> Register Now</a></p>
            ...
            <a class="forget-pass green" href="#">Forgot password?</a>
        </form>
    </div>
</body>
