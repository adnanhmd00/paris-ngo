       ...
       <div class="container-fluid">
        ...
        <div class="card rounded p-4">
            <div class="row m-5 d-flex justify-content-center">
                <div class="col-md-3 text-center border p-4 rounded" style="color: #4479bd;">
                    <div class="d-flex flex-column small">
                        <i class="fa fa-envelope"></i>
                        Email <br>
                    </div>
                    
                    <div>urvashi@gamil.com</div>
                </div>
                <div class="col-md-3 text-center border p-4 m-1 rounded" style="color: #4479bd;">
                    <div class="d-flex flex-column small">
                        <i class="fa fa-phone"></i>
                        Phone <br>
                    </div>
                    
                    <div>+91 9930203871</div>
                </div>
                <div class="col-md-3 text-center border p-4 rounded" style="color: #4479bd;">
                    <div class="d-flex flex-column small">
                        <i class="fa fa-envelope"></i>
            ...
            <div class="container-fluid d-flex justify-content-center align-items-center">
                ...
                <textarea name="" id="" cols="30" rows="3" placeholder="Message"  class="form-control p-1 m-2"></textarea>
                <div class="text-center mt-2">
                    <button id="donate" class="btn btn-success px-5" style="background: #4479bd; padding: 10px 20px; border-radius: 20px;">Send Us A Message    </button>
                </div>
                </form>
